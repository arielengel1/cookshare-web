...
const Layout = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-50 overflow-hidden w-full">
      ...
      <nav className="hidden md:flex flex-col w-64 bg-white border-r border-gray-100 p-6 z-20 shrink-0">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-rose-500 to-orange-400 bg-clip-text text-transparent italic mb-12 pl-2">
          CookShare
        </h1>
      ...
      <main className="flex-1 overflow-y-auto pb-16 md:pb-0 relative bg-gray-50 scroll-smooth">
        <div className="max-w-2xl mx-auto w-full md:my-8 bg-white shadow-xl md:rounded-[40px] overflow-hidden min-h-full md:min-h-[calc(100%-4rem)] border border-gray-100">
          <Outlet />
        </div>
      </main>
